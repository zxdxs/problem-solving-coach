...
(function(){
  ...
  function renderFooter(el){
    ...
    el.innerHTML =
      ...
      /* ICP 备案号：备案通过后必须在网站底部显示并链接工信部（法律责任，不是装饰）。
         来自 data.js 的 PSC_SITE.beian；留空则整段不输出 ⇒ 填号只改 data.js 一行。 */
      (function(){
        try{
          if(typeof PSC_SITE==='undefined' || !PSC_SITE || !PSC_SITE.beian) return '';
          var h = '<div style="margin-top:6px;">ICP 备案：'+
                  '<a href="https://beian.miit.gov.cn/" target="_blank" rel="noopener">'+
                  esc(PSC_SITE.beian)+'</a>';
          if(PSC_SITE.gongan){
            h += '　|　<a href="https://beian.mps.gov.cn/" target="_blank" rel="noopener">'+
                 esc(PSC_SITE.gongan)+'</a>';
          }
          return h+'</div>';
        }catch(e){ return ''; }
      })()+
      ...
      +'版权、授权状态见<a href="provenance.html">版权 · 授权 · 版本溯源</a></div>'
      +'</div>';
  }
